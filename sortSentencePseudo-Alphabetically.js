...
function sort(sentence){
  ...
  let lowerSorted = lowerCase.sort((a,b) => a.localeCompare(b))
  let upperSorted = upperCase.sort((a,b) => b.localeCompare(a))
  return lowerSorted.concat(upperSorted).join(' ')
}